...
def delete_item_selected(widget, JSON_PATH):
    # Delete in UI
    current_layout = detach_widget(widget)[2]
    source_fbx = detach_current_ui(widget, JSON_PATH)[0]
    name_item_selected = detach_current_ui(widget, JSON_PATH)[1]
    folder_item_selected = detach_current_ui(widget, JSON_PATH)[2]

    os.remove(source_fbx + "/" + folder_item_selected + "/" + name_item_selected + ".fbx")
    os.remove(source_fbx + "/" + folder_item_selected + "/" + name_item_selected + ".jpg")
    # Delete in folder
...
def import_fbx(widget, JSON_PATH):
    SOURCE_FBX_PATH = detach_current_ui(widget, JSON_PATH)[0]  # Source path
    name_item_selected = detach_current_ui(widget, JSON_PATH)[1]    # File name 
    folder_name = detach_current_ui(widget, JSON_PATH)[2]   # Folder name
...
def export_fbx(widget, JSON_PATH):
    SOURCE_FBX_PATH = detach_current_ui(widget, JSON_PATH)[0]
    folder_name = detach_current_ui(widget, JSON_PATH)[2]
